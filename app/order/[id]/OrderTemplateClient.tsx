...
export default function OrderTemplateClient({ template }: { template: TemplateType }) {
  ...
  if (status === 'unauthenticated') {
    ...
    router.push(`/login?redirect=/order/${template._id}`);
    return null;
  }
    ...
    <div className="min-h-screen pt-20 pb-16">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <Link href={`/templates/${template._id}`} className="text-purple-400 hover:text-purple-300 flex items-center">
