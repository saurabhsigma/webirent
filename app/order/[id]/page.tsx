...
import OrderTemplateClient from './OrderTemplateClient';
...
export default async function OrderTemplate({ params }: { params: { id: string } }) {
  await connectDB();
  ...
  return <OrderTemplateClient template={template} />;
}